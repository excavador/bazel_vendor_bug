...
func (d Decimal) MarshalPostgreSQL() ([]byte, error) {
	return []byte(d.String()), nil
}


func (self *Decimal) UnmarshalMsgpack(data []byte) (err error) {
	var str string
	if err = msgpack.Unmarshal(data, &str); err != nil {
		return
	}
	err = self.UnmarshalJSON([]byte(str))
	return
}

func (self Decimal) MarshalMsgpack() ([]byte, error) {
	return msgpack.Marshal(self.String())
}
